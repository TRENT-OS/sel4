...
/* The kernel uses ticks_t internally to represent the time, this is driven by
 * the frequency of the hardware timer. The userland API uses time in micro
 * seconds, which is represented by time_t in the kernel.
 */
